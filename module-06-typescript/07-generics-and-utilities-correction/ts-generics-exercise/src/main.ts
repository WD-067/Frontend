...
//    For example:
const name2 = firstItem(["Ada", "Grace"]); // "Ada"
const number = firstItem([10, 20, 30]); // 10
const none = firstItem([]); // undefined

console.log(name2, number, none);
...
// * Gives errors
// console.log(mergeObjects(34, "string"));
// console.log(mergeObjects("string", "string"));
// console.log(mergeObjects({ time: "now" }, "string"));
...
// console.log(pluck(user, "location"));
